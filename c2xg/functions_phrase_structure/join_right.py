...
def join_right(unit, 
	...
	active_list = [(x, y) for (x, y) in pair_status_list if y == unit]
	...
	while True:
		...
		for i in range(len(active_list)):
			...
			elif catenae_sequence[0] in head_status_dictionary and head_status_dictionary[catenae_sequence[0]] == "L":
			...
			elif catenae_sequence[0] not in head_status_dictionary:
			...
			#Otherwise, evaluate#
				...
				new_unit_list = [x for (x, y) in pair_status_list if y == catenae_sequence[0]]
