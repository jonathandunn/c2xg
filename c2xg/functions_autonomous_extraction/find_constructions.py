...
def find_constructions(current_length, 
	...
	from functions_autonomous_extraction.create_shifted_length_df import create_shifted_length_df
	...
	from functions_autonomous_extraction.get_vector_column import get_vector_column
	from functions_autonomous_extraction.get_construction_name import get_construction_name
	...
	for candidate in candidate_list:
		...
		if len(search_df) > 0:
			...
			if write_examples != "":
				from functions_autonomous_extraction.print_constructs import print_constructs
