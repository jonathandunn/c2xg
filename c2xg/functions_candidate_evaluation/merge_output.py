...
def merge_output(output_files, frequency_threshold, number_of_cpus, run_parameter = 0):
	...
	#---------------------------------------#
		...
		from functions_candidate_evaluation.process_merge_output import process_merge_output
		from functions_candidate_evaluation.get_candidate_count import get_candidate_count
