...
def constituents_reduce(pos_list, 
	...
	import pandas as pd
	from functions_constituent_reduction.get_head_first_list import get_head_first_list
	from functions_constituent_reduction.get_head_last_list import get_head_last_list	
	from functions_constituent_reduction.constituents_print import constituents_print
